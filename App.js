...
const App: () => Node = () => {
  ...
  React.useEffect(() => {
    const t = Date.now();
    fetch(
      'https://stg.saarthiapp.com/saarthi-data-service/api/v1/participation/getCoinDifference?contestId=ckn9tney805534tli8pizmfu6&totalQuestions=10&RightAnswers=2&goal=SSC&page=0&limit=10',
      {
        method: 'GET',
        headers: {
          Authorization:
